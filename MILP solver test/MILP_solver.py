...
from multi_operation_planning import download_windsolar_data, GTI, scenario_generation_operation, uncertainty_analysis_operation_MCMC_std,MILP_two_objective,MILP_two_objective
...
if __name__ == "__main__":
    ...
    if editable_data['Perform multi-objective optimization']=='yes':
        ...
        MILP_two_objective.results_repdays(path_test)
